...
const styles = {
  ...
  row: { display: 'flex', gap: '1.25rem', flexWrap: 'wrap' as const },
  formGroup: { display: 'flex', flexDirection: 'column' as const, gap: '0.5rem', flex: 1, minWidth: '200px' },
  label: { fontSize: '0.875rem', fontWeight: 600, color: '#374151' },
  input: { padding: '0.625rem', borderRadius: '6px', border: '1px solid #d1d5db', fontSize: '0.875rem', backgroundColor: 'white', color: '#1f2937' },
  select: { padding: '0.625rem', borderRadius: '6px', border: '1px solid #d1d5db', fontSize: '0.875rem', backgroundColor: 'white', color: '#1f2937' },
  textarea: { padding: '0.625rem', borderRadius: '6px', border: '1px solid #d1d5db', fontSize: '0.875rem', fontFamily: 'inherit', resize: 'vertical' as const, backgroundColor: 'white', color: '#1f2937' },
